...
bot_token = '7392654439:AAHUrnKLJmCxvW3OjZt-1HSENuaSi3nrH9U'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['7400085641']
admin_id = '7400085641'
subscription_data = {}
...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'اهلا بك بوت الرفع الخارجي المطور ,@User_Elite', reply_markup=keyboard)
    else:
        bot.reply_to(message, 'انت غير مشترك في البوت للاشتراك في البوت : @User_Elite')
...
def show_admin_commands(message):
    if str(message.from_user.id) == '7400085641':  
